...
public abstract class DatabaseAccessor extends SQLiteOpenHelper {
    ...
    public DatabaseAccessor(Context context, String name,String[] cols) {
        ...
        tableName = name;
        col = cols;
        Log.d("DatabaseAccessorDebug", databaseName.substring(0,databaseName.length()-3) +"."+tableName+" accessor created");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.d("DatabaseAccessorDebug","Upgrading Database: "+ tableName+" from version: "+oldVersion+" to version: "+newVersion);
    ...
    public int deleteData (String id) {
        Log.d("DatabaseAccessorDebug","Deleting data at id: " + id);
    ...
    public void close() {
        super.close();
        Log.d("DatabaseAccessorDebug","Closing: "+databaseName.substring(0,databaseName.length()-3) +"."+tableName + " accessor");
    }
}
